...
public class NameNode implements NameNodeStatusMXBean {
     ...
     * UGI.getCurrentUser which is synch'edDataXceiverServer
     */
    ...
    private static boolean format(Configuration conf, boolean force, boolean isInteractive) throws IOException {
        ...
        try {
            ...
            if (conf.getBoolean(DFSConfigKeys.DFS_REFORMAT_DISABLED, DFSConfigKeys.DFS_REFORMAT_DISABLED_DEFAULT)) {
                force = false;
                isInteractive = false;
